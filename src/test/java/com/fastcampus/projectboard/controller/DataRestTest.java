...
public class DataRestTest {
    ...
    @DisplayName("[api] 게시글 댓글 리스트 조회")
    @Test
    void givenNothing_WhenRequestingArticleCommentsFromArticles_ThenReturnArticlesJsonResponse() throws Exception {
        // Given
    ...
    @Test
    void givenNothing_WhenRequestingArticleComments2FromArticles_ThenReturnArticlesJsonResponse() throws Exception {
        // Given
